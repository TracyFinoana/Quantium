(function ($) {
    ...
    $(window).scroll(function () {
        ...
        //project
        if ($(this).scrollTop() > 1300 && $(this).scrollTop() < 2500) {
            $('.nav-link-project').addClass('active');
        } else {
            $('.nav-link-project').removeClass('active');
        }
        //service
        if ($(this).scrollTop() > 2500 && $(this).scrollTop() < 3500) {
        ...
        if ($(this).scrollTop() > 3500 && $(this).scrollTop() < 4500) {
            $('.nav-link-team').addClass('active');
        } else {
            $('.nav-link-team').removeClass('active');
        }
        //contact animation
